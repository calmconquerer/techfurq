...
from .models import AboutUsQuote, AboutUs, AboutUsSectionOne, \
                    AboutUsSectionOneHeading, AboutUsSectionTwo, AboutUsSectionTwoHeading, ServiceEightHeading, \
                    ServiceThreeHeading, ServiceFiveHeading, ServiceFourHeading, ServiceTwoHeading, ServiceOneHeading, \
                    ServiceSevenHeading, ServiceSixHeading
...
def home(request):
    ...
    service_one_heading = ServiceOneHeading.objects.all()
